...
The skill keeps its core workflow concise and loads focused scouting, context-planning,
change-analysis, quality, or diagnostic guidance only when the task needs it.
